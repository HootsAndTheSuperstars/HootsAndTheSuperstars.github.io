export class PreLoader extends Phaser.Scene{
    ...
    preload (){
        ...
        this.load.image('DemoVer', 'assets/Title Screen/demoText.png')
        ...
        this.load.spritesheet('returnTitle', 'assets/GameOver/returnTitle.png', {frameWidth: 294, frameHeight: 26})
